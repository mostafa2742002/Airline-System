...
public class CustomerBook extends javax.swing.JFrame {
    ...
    public CustomerBook() {
        ...
        {
            travelsArray[i] = travels.get(i).getAirport_name() + " To " +  travels.get(i).getTo(); 
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else 
        {
           ...
           Airline a = travels.get(selected);
           Customer c = new Customer(idd,nam,phon,a);
           customers.add(c);
           saveabookToFile();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
